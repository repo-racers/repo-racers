...
should be made in the [Decision Log](../decision_log/README.md) documenting the decision.
...
[Decision Log](../decision_log/README.md) that has references back to the full text of the trade study.
