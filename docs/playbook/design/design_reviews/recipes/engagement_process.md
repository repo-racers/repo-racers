...
In many engagements Microsoft works with customers using a SCRUM agile development process which begins with sprint planning. [Sprint planning](../../../agile_guide/how_we_roll/how_we_roll.md) is a great opportunity to dive deep into the next set of high priority work. Some key points to address are the following:
...
If your team is not already hosting a [Sprint Backlog Refinement](../../../agile_guide/beyond_the_basics/backlog_management/backlog_management.md) session at least once per week you should consider it. It is a great opportunity to:
...
[Sprint retrospectives](../../../agile_guide/how_we_roll/how_we_roll.md) are a great time to check in with the dev team, identify what is working or not working, and propose changes to keep improving.
...
> **Tip:** Keep your artifacts up to date by adding it to your teams [Definition of Done](../../../agile_guide/beyond_the_basics/backlog_management/backlog_management.md) for all user stories.
