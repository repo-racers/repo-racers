...
The generalized best practices are in  [Network Architecture Guidance for Azure#Hub and Spoke topology](network_architecture_guidance_for_azure.md#hub_and_spoke_topology)
...
The general best practices are available in the [Network Architecture Guidance for Azure#ip-allocation](network_architecture_guidance_for_azure.md#ip_allocation)
...
General best practices are available in [Network Architecture Guidance for Azure#dns](network_architecture_guidance_for_azure.md#dns)
