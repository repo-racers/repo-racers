...
- The story owner and pairing assignee do not merely split the work up and sync regularly – they actively work together on the same tasks, and might share their screens via a Teams online session. Collaborative tools like [GitHub Codepsaces](https://github.com/features/codespaces) can be preferable to sharing screens. Not all collaboration needs to be screen-share based.
...
- [Pair Programming with GitHub Codespaces and VSCode](./pair_programming.md)
